...
This document provides guidelines for internationalization of the Grailum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `grailum_en.ts` remains unchanged.

...
* grailum.conf: contains configuration settings for grailumd or grailum-qt
* grailumd.pid: stores the process id of grailumd while running
...
* debug.log: contains debug information and general logging generated by grailumd or grailum-qt
